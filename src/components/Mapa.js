...
return (
    ...
    <Fragment>
        ...
        <div className="d-flex justify-content-around mt-4">
            <Button href={buscar_ubicacion} className="button1 mr-3" size="lg">Volver a casa </Button>

            <Button href={llamar_contacto} className="button1" size="lg">Llamar cuidador</Button>
        </div>
        <Footer />
    </Fragment>
)
